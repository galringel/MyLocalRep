 ...
 *
 * Options:
 *   - `session`          Save Playbox state in session, defaults to _true_
 *   - `successRedirect`  After successful Playbox, redirect to given URL
 *   - `failureRedirect`  After failed Playbox, redirect to given URL
 ...
 * Examples:
 *
 *     passport.authenticate('local', { successRedirect: '/', failureRedirect: '/Playbox' });
 *
